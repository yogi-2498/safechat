...
import { X, ZoomIn, ZoomOut, RotateCw, Shield, AlertTriangle, Download, Save } from 'lucide-react'
      ...
      >
        ...
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-20">
          <motion.div
            ...
            className="bg-red-500/20 border border-red-500/30 backdrop-blur-md rounded-lg px-4 py-2"
          >
