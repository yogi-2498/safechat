    ...
    const detectDevTools = () => {
      if (
        ...
        if (!devtools.open) {
          devtools.open = true
          console.clear()
          console.log('%c💕 SafeChat - Security Notice', 'color: #ff69b4; font-size: 24px; font-weight: bold; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);')
          console.log('%c⚠️ Developer tools detected!', 'color: #ff8800; font-size: 18px; font-weight: bold;')
          console.log('%cFor security reasons, please close developer tools while using SafeChat.', 'color: #ffaa00; font-size: 14px;')
          ...
          overlay.innerHTML = `
            <div style="max-width: 500px;">
              ...
              <h2 style="color: #DC143C; margin-bottom: 20px; font-size: 24px;">Security Warning</h2>
              <p style="margin-bottom: 20px; font-size: 16px; line-height: 1.5;">
                Developer tools detected. For your security and privacy, 
                please close the developer tools to continue using SafeChat.
              </p>
              <p style="color: #8B5A6B; font-size: 14px;">
